...
# ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    def PlotTotalUncer(self, DataError, DataContent, SignalError, SignalContent, BackgroundUnce, SFUncertainty, CalibrationUncer, RecoilUncer, Indice, channel, lepton, var, multi, Energy):
        ...
        if(lepton == "mu"):
            ...
            plt.text(0,     5, r' 25 < $p_{T}^{\ell}$ < 30', fontsize=15)
            plt.text(2.4,   5, r' 30 < $p_{T}^{\ell}$ < 35', fontsize=15)
            plt.text(4.8,   5, r' 35 < $p_{T}^{\ell}$ < 40', fontsize=15)
            plt.text(7.2,   5, r' 40 < $p_{T}^{\ell}$ < 45', fontsize=15)
            plt.text(9.6,   5, r' 55 < $p_{T}^{\ell}$ < 50', fontsize=15)
            plt.text(12.,   5, r' 50 < $p_{T}^{\ell}$ < 100', fontsize=15)
        ...
        if(lepton == "el"):
            plt.text(0,      5, r' 25 < $p_{T}^{\ell}$ < 30', fontsize=15)
            plt.text(2.47,   5, r' 30 < $p_{T}^{\ell}$ < 35', fontsize=15)
            plt.text(4.94,   5, r' 35 < $p_{T}^{\ell}$ < 40', fontsize=15)
            plt.text(7.41,   5, r' 40 < $p_{T}^{\ell}$ < 45', fontsize=15)
            plt.text(9.88,   5, r' 45 < $p_{T}^{\ell}$ < 50', fontsize=15)
            plt.text(12.35,  5, r' 50 < $p_{T}^{\ell}$ < 100', fontsize=15)
